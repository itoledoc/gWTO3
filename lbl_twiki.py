...
header = str(
    ...
    '[[http://tableau.alma.cl/views/Available/Dashboard1?:embed=y&:showShareOptions=true&:display_count=no]'
    '[What is up? (Currently down, will be up and running '
    'again on November 19th evening]]\n\n The user is \'tableuser\' and the password should be avalaible with the AoD '
    'Lead (or otherwise send email to itoledo@alma.cl) Please, only one user should be logged with that account at the '
